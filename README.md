...
| File | Description |
|---|---|
| `train_classifier_12_05_26.py` | Main training script. Runs grouped repeated nested cross-validation, trains multiple classifiers, saves metrics, confusion matrices, feature importances, and statistical test outputs. |
...
The current configuration runs the `CTRLV_VS_NULLV` task and uses a grouped repeated cross-validation design with one or 5 repeats, 3 outer folds, and 2 inner folds.
